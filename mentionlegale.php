...
?>
<div class="wrap4">
    <div id="mention" class="justify-content-center">
        <div id="titre" class="d-flex flex-column text-center mt-4 mb-5">
            <h1 id="bienvenue" class="text-uppercase text-primary mb-2">Mentions Légales</h1>
            <br>
            <p>NetworkVIP</p>
        </div>
        <div class="mention-box">
            <div class="mentions">
                <h1 class="minititre">Mentions légales</h1>
                <div class="mention-text">
                    <p>Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 pour la confiance en l’économie numérique, il est précisé aux utilisateurs du site networkvip.fr l’identité des différents intervenants dans le cadre de sa réalisation et de son suivi.</p>
                </div>
            </div>
